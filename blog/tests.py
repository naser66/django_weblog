...
class BlogPostTest(TestCase):
    ...
    def test_post_detail(self):
        self.assertEqual(self.post1.title, 'TestPost')
        self.assertEqual(self.post1.text, 'This is the Test.')
    ...
    def test_post_title_in_list_page(self):
        response = self.client.get(reverse('post_list'))
        self.assertContains(response, self.post1.title)

    def test_post_text_on_list_page(self):
        response = self.client.get(reverse('post_list'))
    ...
    def test_post_if_dos_not_exist(self):
    ...
    def test_post_update_view(self):
        ...
        self.assertEqual(Post.objects.last().text, 'Test Update Text')
